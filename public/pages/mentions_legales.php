...
<section class="mentions_legales bg-light py-5">
    <div class="container">
        ...
        <section class="bg-white p-4 rounded shadow-sm mb-4 border-start border-danger border-4">
            <h3 class="text-secondary mb-3"><i class="bi bi-server"></i> 2. Hébergeur du site</h3>
            <p>
                <strong>Nom :</strong><br>
                <strong>Adresse :</strong><br>
                <strong>Téléphone :</strong><br>
                <strong>Site Web :</strong> <a href="" target="_blank"></a>
            </p>
        </section>

        <!-- Propriété intellectuelle -->
        <section class="bg-white p-4 rounded shadow-sm mb-4 border-start border-warning border-4">
            <h3 class="text-secondary mb-3"><i class="bi bi-shield-lock"></i> 3. Propriété intellectuelle</h3>
            <p>
        ...
        <section class="bg-white p-4 rounded shadow-sm mb-4 border-start border-success border-4">
            <h3 class="text-secondary mb-3"><i class="bi bi-cookie"></i> 5. Cookies</h3>
            <p>
        ...
        <!-- Droit applicable -->
        <section class="bg-white p-4 rounded shadow-sm mb-4 border-start border-black border-4">
            <h3 class="text-secondary mb-3"><i class="bi bi-journal-text"></i> 6. Droit applicable</h3>
            <p>
